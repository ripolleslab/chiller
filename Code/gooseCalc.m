function [greyscale,results,baseline] = gooseCalc(img,grayscale,n,results,t,B,baseline,f)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
elseif B==1
    baseline=nanmean(results(n-11:n-1));
    results(1,1:n)=0;
    plot(results(1,:))
...
% the figure
 ...
 %If the percentage of change is greater than 30%, a goosebump is detected. Save that result  
    ...
    plot(1:1000,goose,'r','LineWidth',1)
...
saveas(gcf,['Chiller' num2str(f.Number) num2str(n) '.fig'])
