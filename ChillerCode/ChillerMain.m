...
rpi = raspi('10.23.10.128','pi','raspberry');
...
%         end
    ...
    [grayscale,results,baseline]=gooseCalc(img,grayscale,ii,results,ceil(t(ii)),B,baseline,f);
...
save chiller_results results timerec tt
